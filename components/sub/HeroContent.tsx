  ...
  >
    <div className="w-full max-w-[800px] mx-auto px-4 sm:px-0">
      ...
      <motion.div
        ...
        className="flex flex-col gap-6 mt-6 text-4xl sm:text-6xl font-bold text-white max-w-full w-full"
      >
        <span>
          Providing
      ...
      <motion.p
        ...
        className="text-base sm:text-lg text-gray-400 my-5 max-w-full"
      >
