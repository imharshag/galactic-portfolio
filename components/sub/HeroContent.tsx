...
const HeroContent = () => {
  return (
    ...
    >
<div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start px-4 sm:px-0">
  <motion.div
  ...
  <motion.div
    ...
    className="flex flex-col gap-6 mt-6 text-4xl sm:text-6xl font-bold text-white max-w-full sm:max-w-[600px] w-auto h-auto"
  >
    <span>
      Providing
  ...
  <motion.p
    ...
    className="text-base sm:text-lg text-gray-400 my-5 max-w-full sm:max-w-[600px]"
  >
